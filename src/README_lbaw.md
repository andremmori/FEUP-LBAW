...
Example configuration:
    ...
    DOCKER_USERNAME=lbaw2066 # Replace by your docker hub username
    IMAGE_NAME=lbaw2066     # Replace by your lbaw group name
...
You can test the image locally by running:
    ...
    docker run -it -p 8000:80 -e DB_DATABASE="lbaw2066" -e DB_USERNAME="lbaw2066" -e DB_PASSWORD="pass" lbaw2066/lbaw2066
